...
st.markdown(
    ...
    /* =========================================================================
       [수정됨] 전송 버튼(보낼 내용 입력 시) 빨간색 변함 방지 
       ========================================================================= */
    /* Streamlit의 기본 테마 색상이 버튼 내부 아이콘(svg)에 적용되는 것을 막기 위해 모든 하위 요소(*)를 타겟팅합니다. */
...
if not st.session_state.messages:
    ...
    st.markdown(
        ...
        /* ==========================================================
           [수정됨] 초기 화면 FAQ 라벨 텍스트 위치 (버튼들과의 간격 조정) 
           ========================================================== */
        .faq-fixed-label {
            position: fixed;
            
            /* [직접 수정 안내] 
               이전에는 -45px 이었습니다. 현재 -25px로 변경하여 텍스트를 위로 올렸습니다.
               - 텍스트를 더 위로 올리려면: 숫자를 0px이나 +10px로 변경하세요.
               - 텍스트를 다시 아래로 내리려면: -40px 등 음수 값을 늘리세요. */
            bottom: calc(45% - 25px); 
        ...
        .st-key-faq_area {
            ...
            /* [직접 수정 안내] 
               버튼들의 위치입니다. 위 라벨과의 간격을 더 벌리고 싶다면
               아래의 -120px 을 -140px, -150px 등으로 더 내려주시면 됩니다. */
            bottom: calc(45% - 120px); 
    ...
    st.markdown(
        ...
        /* ==========================================================
           [수정됨] 대화 중 화면 FAQ 라벨 텍스트 위치 (버튼들과의 간격 조정) 
           ========================================================== */
        .faq-fixed-label {
            position: fixed;
            
            /* [직접 수정 안내] 
               이전에는 70px 이었습니다. 현재 95px로 변경하여 텍스트를 위로 올려 간격을 넓혔습니다.
               - 더 간격을 넓히려면: 110px 등으로 숫자를 키우세요.
               - 간격을 좁히려면: 80px 등으로 숫자를 줄이세요. */
            bottom: 95px; 
        ...
        .st-key-faq_area {
            ...
            /* [직접 수정 안내] 
               대화 중 버튼들의 위치입니다. 
               더 바닥으로 내리고 싶다면 15px을 5px 등으로 줄이시면 됩니다. */
            bottom: 15px; 
    ...
    try:
        ...
        return [
            ...
            {"source": "근로기준법 제56조(연장·야간 및 휴일 근로)",
             "content": "사용자는 연장근로에 대하여 통상임금의 100분의 50 이상을 가산하여 근로자에게 지급하여야 일한다. 야간근로(오후 10시부터 다음 날 오전 6시)에 대해서도 동일하게 가산한다."},
