...
st.markdown(
    ...
    /* svg path까지 지정한 이유: 아이콘이 svg > path 형태라 fill이 path에 직접 걸려있는
       스트림릿 버전도 있어서, 상위 svg만 지정하면 안 먹는 경우를 대비한 것입니다. */
    [data-testid="stChatInputSubmitButton"]:not(:disabled),
    [data-testid="stChatInputSubmitButton"]:not(:disabled) svg,
    [data-testid="stChatInputSubmitButton"]:not(:disabled) svg path {
        color: #3434e0 !important; 
    ...
    [data-testid="stChatInputSubmitButton"][aria-disabled="true"] svg path {
