...
st.markdown(
    ...
    /* [수정됨] 전송 버튼(보낼 내용 입력 시) 빨간색 변함 방지 및 브랜드 컬러 적용 */
    /* 활성화(입력) 되었을 때의 색상을 브랜드 강조색으로 강제 고정합니다. */
...
if not st.session_state.messages:
    ...
    st.markdown(
        ...
        .st-key-faq_area {
            ...
            /* [위치 조정] 💡버튼 블록 위치: 채팅창(45%)보다 115px 아래로 배치 */
            /* 간격이 너무 좁다면 이 숫자(-115px)를 -130px 등으로 더 빼주시면 됩니다. */
    ...
    st.markdown(
        ...
        .faq-fixed-label {
            ...
            /* 대화 중 FAQ 라벨 높이 (채팅창 바닥 120px에서 충분히 떨어진 70px) */
            bottom: 70px; 
